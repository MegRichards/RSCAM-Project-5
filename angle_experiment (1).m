...
theta_vals = [0,pi/12,pi/10,pi/8,pi/6];
        ...
        for ncorner=1:number_corners
            ...
            if angle < 0
                ...
                for j=1:(3*n)
                    ...
                    if beta>distmin
                    d = [d beta];
                    poles = [poles new_pole(polygon, ncorner, beta, theta, false)];
                    end
                    if beta<distmax
                        delta = beta;
        ...
        for ncorner=1:number_corners
            ...
            if angle < 0
                ...
                for j=1:(3*n)
                    ...
                    d = [d beta];
                    poles = [poles new_pole(polygon, ncorner, beta, theta, true)];
                    end
                    if beta<distmax
                        delta = beta;
                        [b1, b2, n1, n2] = new_boundary_normal(polygon, ncorner, delta/3);
        ...
        for ncorner=1:number_corners
            ...
            if angle < 0
                ...
                for j=1:(3*n)
                    ...
                    d_in = [d_in beta];
                    poles_in = [poles_in new_pole(polygon, ncorner, beta, theta, false)];
                    d_ex = [d_ex beta];
                    poles_ex = [poles_ex new_pole(polygon, ncorner, beta, theta, true)];
                    end
                    if beta<distmax
                        delta = beta;
                        [b1, b2, n1, n2] = new_boundary_normal(polygon, ncorner, delta/3);
